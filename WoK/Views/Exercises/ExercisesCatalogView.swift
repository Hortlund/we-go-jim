...
struct ExercisesCatalogView: View {
                ...
                if !viewModel.sections.isEmpty {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 12, style: .continuous)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 12, style: .continuous)
                                    .fill(WoKTheme.field.opacity(0.55))
                            )
                    )
                    .padding(.trailing, 2)
                }
                ...
                Image(systemName: "arrow.up.arrow.down")
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 10, style: .continuous)
                            ...
                            .overlay(
                                RoundedRectangle(cornerRadius: 10, style: .continuous)
                                    .fill(WoKTheme.field.opacity(0.6))
                            )
                            .overlay(
                                RoundedRectangle(cornerRadius: 10, style: .continuous)
        ...
        HStack(spacing: 10) {
            ...
            Button {
                ...
                Image(systemName: "plus.circle.fill")
                    ...
                    .background(
                        Circle()
                            .fill(WoKTheme.bgElevated.opacity(0.95))
                    )
            }
            .buttonStyle(.plain)
    ...
    private var emptyState: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            } else if catalogExercises.isEmpty {
                Text(loadState == .failed ? "Exercises could not be loaded yet." : "Exercises are still loading.")
                    .font(.subheadline)
                    .foregroundStyle(WoKTheme.textSecondary)
                Button("Retry") {
                    Task {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ExerciseCatalogThumbnail(exercise: exercise, repository: repository, placeholderPadding: 20)
                    .frame(maxWidth: .infinity)
                    .frame(height: 220)
                    .background(WoKTheme.field)
                    .clipShape(RoundedRectangle(cornerRadius: 16, style: .continuous))
                    .overlay(
                        RoundedRectangle(cornerRadius: 16, style: .continuous)
                            .stroke(WoKTheme.accentBlue.opacity(0.25), lineWidth: 1)
                    )
