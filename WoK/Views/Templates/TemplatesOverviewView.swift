...
struct TemplatesOverviewView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    WoKSectionHeader("Folder Filter", subtitle: "Use chips to focus templates")
                ...
                VStack(alignment: .leading, spacing: 10) {
                    WoKSectionHeader("Template Library", subtitle: "Manage workouts without hidden menus")

                    if displayedTemplates.isEmpty {
                        Text("No templates for this filter yet.")
                            .font(.subheadline)
                ...
                VStack(alignment: .leading, spacing: 10) {
                    WoKSectionHeader("Folders", subtitle: "Open, rename, and organize templates")
    ...
    private func folderChip(_ filter: FolderFilter, title: String) -> some View {
        Button {
            ...
            WoKChip(title: title, isSelected: folderFilter == filter)
        }
        .buttonStyle(.plain)
    }
